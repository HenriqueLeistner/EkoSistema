...
# Page configuration
st.set_page_config(
    page_title="Ekobrazil - Dados de Clientes",
    page_icon="🌿",
    layout="wide",
            ...
            with st.spinner('Processando dados...'):
                ...
                if sort_option == "Nome":
                    ...
                    if len(filtered_df_with_dates) > 0:
                        ...
                        filtered_df_with_dates = filtered_df_with_dates.sort_values('date_sort', ascending=False)
                        filtered_df_with_dates = filtered_df_with_dates.drop('date_sort', axis=1)
                        
                        filtered_df = pd.concat([filtered_df_with_dates, filtered_df_without_dates], ignore_index=True)
                ...
                if len(filtered_df) > 0:
                    ...
                    if 'days_since_purchase' in display_df.columns:
